...
public class InvalidCommand extends Command {
    ...
    public static String TEMPLATE_FILE_MISSING_MESSAGE = "Template file is missing! Regenerate Template File... Please try again";
    public static String RECIPE_FILE_MISSING_MESSAGE = "Recipe File is missing! Regenerate Recipe File! Please try again!";
