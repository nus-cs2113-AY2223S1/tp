...
public class ASCIIArtGenerator {
     ...
     * @throws Exception exception thrown if encountered
     */
    private static void printTextArt(String artText, int textHeight, ASCIIArtFont fontType, String artSymbol) throws Exception {
