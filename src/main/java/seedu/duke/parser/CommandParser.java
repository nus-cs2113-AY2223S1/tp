...
/**
 * Class to handle parsing user input and creating Command after checking for
...
public class CommandParser {
     ...
     *
     * @throws InvalidUserCommandException if the user command does not follow the
     *                                     command format laid out
     */
     ...
     * @return Lesson if the user input is a valid command on timetables, null
     *         otherwise.
     *
     * @throws ModuleNotFoundException if user input module code is not found in
     *                                 database
     * @throws InvalidModuleException  if module details are invalid when passed
     *                                 into Lesson constructor
     */
    ...
    /**
     * private static String parseComment(String[] parameters) throws
     ...
     * }
     * 
     * String[] commentArray = Arrays.copyOfRange(parameters, COMMENT_INDEX,
     * parameters.length);
     ...
     * 
     * if (isValidComment(commentStartIndex, commentEndIndex) &&
     * !isEmptyComment(commentStartIndex, commentEndIndex)) {
     * return comment.substring(commentStartIndex + 1, commentEndIndex);
     * }
     * 
     * throw new InvalidCommentException("Error! The comment " + comment + " is
     * invalid!");
     * }
     * 
     * private static boolean isValidComment(int commentStartIndex, int
     * commentEndIndex) {
     ...
     * }
     * 
     * private static boolean isEmptyComment(int commentStartIndex, int
     * commentEndIndex) {
     ...
     * @return True if user input option is a valid view command option. False
     *         otherwise.
     */
     ...
     *
     * @param option User input option
     * @return True if user input option is a valid list command option. False
     *         otherwise.
     */
     ...
     *
     * @param option User input option
     * @return True if user input option is a valid favourite command option. False
     *         otherwise.
     */
     ...
     *
     * @param parameters User input split by spaces.
     * @return True if user input is a valid command on universities. False
     *         otherwise.
     */
    ...
    /**
     * Split user input by spaces and process each parameter by removing
     * underscores.
     *
     * @param userInput A line of user input.
     * @return An array of user input parameters split by spaces with underscores
     *         removed.
     */
