...
public enum ErrorMessages {
    ...
    ERROR_INPUT_INVALID_AMOUNT("Invalid amount, "
    ...
    ERROR_INPUT_INVALID_INDEX("Invalid index, please ensure your index is correct!"),
    ERROR_INPUT_INVALID_MONTH("Invalid month, please check your input!"),
    ERROR_INPUT_INVALID_YEAR("Invalid year, please check your input!"),
    ERROR_INPUT_MISSING_TAG("Mandatory tag(s) missing, please check your input!"),
